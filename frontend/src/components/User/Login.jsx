...
const Login = () => {
  ...
  }, [error, success, dispatch, navigate, isAuthenticated, redirect, loading]); 
        ...
        <div className="hidden lg:flex lg:col-span-5 bg-indigo-600 p-12 flex-col justify-between text-white relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <p className="text-indigo-100 text-sm leading-relaxed">
              Log in to access your secure profile dashboard, track active
              shipping orders, and review saved wishlist items.
            </p>
          </div>
